...
export default class MouBrowserTokenSelector extends MouApplication {
  ...
  static PARTS = {
    content: { template: `modules/${MODULE_ID}/templates/browser-token-selector.hbs` }
  }
  ...
  async _onRender(context: AnyDict, options: AnyDict) {
    ...
    this.html.find(".actions button").on("click", this._onAction.bind(this))
  }
